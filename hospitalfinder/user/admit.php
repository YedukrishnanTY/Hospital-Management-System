...
<body id="page-top" data-spy="scroll" data-target=".navbar-fixed-top">
	...
	<!--subscribe-->
	<div class="about" id="admit">
		<div class="container">
			<div class="w3ls-heading">
				<h3>Admit Cards</h3><br/>
			</div>
			
			<?php
			 $logid=$_SESSION['id'];
			$sqlb="select * from admitcard where username=(select username from user where logid=$logid)";
			$resb=$obj->exe($sqlb);
