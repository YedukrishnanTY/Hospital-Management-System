				...
				<div class="container">
					...
					<div class="collapse navbar-collapse navbar-ex1-collapse">
						<ul class="nav navbar-nav navbar-right cl-effect-15">
							...
							<li><a href="review.php"> &nbsp; Post Reviews</a></li>
...
<div class="line">
	...
	<div class="about" id="review">
		<div class="container">
			...
			<?php
			$logid=$_SESSION['id'];
			$select3="select * from hospital";
			$res3=$obj->exe($select3);
			$select4="select * from user where logid=$logid";
			$res4=$obj->exe($select4);
			?>
			<form name="form_edit2" method="post" enctype="multipart/form-data" class="login"  action="reviewpro.php">
			...
			?>
                   ...
                   <tr><td><label>Username</label></td><td>
                    <input type="text"  value="<?php echo $row4['username'];?>" readonly="" name="uname"/></td></tr>
					<?php
				...
				?>
                  ...
                  <tr><td><label>Hospital Name</label></td><td>
					<select name="hospital" ><option value="0">--SELECT--</option>
					<?php
			...
			?>
				...
				?>
					...
					<tr><td><label>Review</label></td><td>
                    <input type="radio" name="review"  value="excelent" required/> Excelent
                    <input type="radio" name="review" value="good" required/>Good
					<input type="radio" name="review" value="poor" required/>Poor
                    </td></tr>
                </table>
				<input type="submit" name="submit" value="Submit" onClick="return review()" >
            </form>
...
if(document.form_edit2.hospital.value=="0")
{
alert("select hospital");
document.form_edit2.hospital.focus();
return false;
}
if((document.form_edit2.review[0].checked==false) && (document.form_edit2.review[1].checked==false ))//radiobutton name=gender
{
alert("select your Review");
