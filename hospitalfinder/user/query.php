...
<div class="line">
	...
	<div class="about" id="query">
		<div class="container">
			...
			?>
			<form name="form_edit" method="post" enctype="multipart/form-data" class="login"  action="querypro.php">
			...
			?>
                   ...
                   <tr><td><label>Username</label></td><td>
                    <input type="text"  value="<?php echo $row1['username'];?>" readonly="" name="uname"/></td></tr>
					<?php
				...
				?>
                  ...
                  <tr><td><label>Doctor Name</label></td><td>
					<select name="doctor" ><option value="0">--SELECT--</option>
					<?php
			...
			?>
				...
				?>
					...
					<tr><td><label> Query</label></td><td>
                    <textarea rows="5" cols="90" name="query" placeholder="Query" required ></textarea></td></tr>
                   
                
				<tr><td colspan="2" align="center"><input type="submit" name="submit" value="Submit" onClick="return query()" ></td></tr>
				</table>
				</form>
				<a href="#myModalq" class="w3more" data-toggle="modal"><i class="fa fa-mail-forward" aria-hidden="true"></i> Replies</a>
...
return false;
	...
	if(!(isNaN(document.form_edit.uname.value)))
{
alert("Only alphabets are allowed");
document.form_edit.uname.focus();
return false;
}
if(document.form_edit.doctor.value=="0")
{
alert("select doctor");
document.form_edit.doctor.focus();
return false;
}
}
</script>
...
<!-- //about -->
<!-- modal --><!-- for pop up -->
<div class="modal about-modal fade" id="myModalq" tabindex="-1" role="dialog">
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			<div class="modal-header"> 
				...
				<h4 class="modal-title">Query Replies</h4>
			</div> 
		<div class="modal-body">
			<div class="agileits-w3layouts-info">
			<?php
			 $logid=$_SESSION['id'];
			$sqlq="select * from qreply where username=(select username from user where logid=$logid)";
			$resq=$obj->exe($sqlq);
		  $noq=mysqli_num_rows($resq);
		  if($noq==0)
		  {
