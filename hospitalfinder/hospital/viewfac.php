...
?>
	...
	<div class="about" id="department">
		...
		<br/> <br/> <br/> <br/> <br/>
			...
			<?php
			 $logid=$_SESSION['id'];
			$sql="select * from facilities where hosname=(select hosname from hospital where logid=$logid)";
			$res=$obj->exe($sql);
		  ...
		  ?>
						<tr>
							...
							<td> <a href="editfac.php?un=<?php echo $row[0]?>">Edit</a> / <a href="delfac.php?un=<?php echo $row[0]?>">Delete</a></td>
