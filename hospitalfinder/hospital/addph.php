...
?>
					...
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="addph.php">Pharmacists</a></li>
								</ul>
							</li>
	...
	<div class="about" id="doctor">
		<div class="container">
		<br/> <br/> <br/> <br/> <br/>
			<h3 class="title">Add Pharmacists</h3>
			<?php
			 $logid=$_SESSION['id'];
		  ...
		  ?>
			...
			<form name="form_edit4" method="post" enctype="multipart/form-data" class="login"  action="phpro.php">
		  ...
		  ?>
                    ...
                    <input type="text" name="hosname" value="<?php echo $row1[1];?>" placeholder="Hospital Name" class="form-control" /></td></tr>
					 <?php
			}
			?>
				...
				<tr><td><label>Pharmacist Name</label></td><td>
                    <input type="text" name="docname" placeholder="Pharmacist Name" class="form-control" /></td></tr>
				...
				<div class=" col-md-4 w3layouts_more-buttn">
											<a href="viewph.php">View Pharmacists</a>
										</div>
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp;
