...
?>
	...
	<div class="about" id="department">
		<div class="container">
		<br/> <br/> <br/> <br/> <br/>
			<h3 class="title"> Add DebitCard</h3>
		  ...
		  ?>
			...
			<form name="form_editd" method="post" enctype="multipart/form-data" class="login"  action="adddebitpro.php">
		  ...
		  ?>
                    ...
                    <input type="text" name="hosname" required="required" value="<?php echo $row[1];?>" readonly="" placeholder="Hospital Name" class="form-control" /></td></tr>
					 <?php
			}
			?>
					<tr><td><label>Account Number</label></td><td>
                    <input type="text" name="acno" required="required" placeholder="Account Number" class="form-control" /></td></tr>
					<tr><td><label>Cvv</label></td><td>
                    <input type="text" name="cvv" required="required" placeholder="Cvv" class="form-control" /></td></tr>
					<tr><td><label>Balance</label></td><td>
                    <input type="text" required="required" name="balance" placeholder="Balance" class="form-control" /></td></tr>
					 
                </table>
				
				 <input type="submit" name="submit" value="Submit" onClick="return debit()" >
            </form>
            <script type="text/javascript">
function debit()
{
	if(document.form_editd.hosname.value=="")
{
alert("Hospital Name Missing");
document.form_editd.hosname.focus();
return false;
    }
	if(!(isNaN(document.form_editd.hosname.value)))
{
...
if(document.form_editd.balance.value=="")
{
alert("Enter 	balance");
