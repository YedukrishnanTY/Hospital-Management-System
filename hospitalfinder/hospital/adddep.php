...
?>
	...
	<div style="background-color: #FFFFFF" class="about" id="department">
		<div class="container">
			<br/> <br/> <br/> <br/> <br/>
			<h3 class="title">Add Departments</h3>
			<?php
			 $logid=$_SESSION['id'];
		  ...
		  ?>
			...
			<form name="form_edit1" method="post" enctype="multipart/form-data" class="login"  action="departmentaddpro.php">
		  ...
		  ?>
                    ...
                    <input type="text" name="hosname" value="<?php echo $row[1];?>" placeholder="Hospital Name" class="form-control" readonly="" /></td></tr>
					 <?php
			}
			?>
					<tr><td><label>Department Name</label></td><td>
                    <input type="text" name="dname" placeholder="Department Name" class="form-control" /></td></tr>
					 
                </table>
				<div class=" col-md-4 w3layouts_more-buttn">
											<a href="viewdepart.php">View Departments</a>
										</div>
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
...
function depart()
{
	if(document.form_edit1.hosname.value=="")
{
alert("Hospital Name Missing");
document.form_edit1.hosname.focus();
return false;
    }
	if(!(isNaN(document.form_edit1.hosname.value)))
{
alert("Only alphabets are allowed");
document.form_edit1.hosname.focus();
return false;
}
if(document.form_edit1.dname.value=="")
{
alert("Enter Department");
document.form_edit1.dname.focus();
return false;
    }
	if(!(isNaN(document.form_edit1.dname.value)))
{
alert("Only alphabets are allowed");
document.form_edit1.dname.focus();
return false;
