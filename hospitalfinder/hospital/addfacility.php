...
?>
	...
	<!--subscribe-->
	<div class="about" id="facility">
		<div class="container">
		<br/> <br/> <br/> <br/> <br/>
			<h3 class="title">Add Facility</h3>
			<?php
			 $logid=$_SESSION['id'];
			$sql3="select * from hospital where logid=$logid";
			$res3=$obj->exe($sql3);
		  
		  ?>
			</p>
			<form name="form_edit2" method="post" enctype="multipart/form-data" class="login"  action="addfacilitypro.php">
		  ...
		  ?>
                    ...
                    <input type="text" name="hosname" value="<?php echo $row3[1];?>" placeholder="Hospital Name" class="form-control" readonly="" /></td></tr>
					 <?php
			}
			?>
					<tr><td><label>Facility</label></td><td>
                    <input type="text" name="fname" placeholder="Facility" class="form-control" /></td></tr>
				...
				<div class=" col-md-4 w3layouts_more-buttn">
											<a href="viewfac.php">View Facilities</a>
										</div>
				&nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 
				<input type="submit" name="submit" value="Submit" onClick="return facility()" >
            </form>
			<script type="text/javascript">
function facility()
{
	if(document.form_edit2.hosname.value=="")
{
alert("Hospital Name Missing");
document.form_edit2.hosname.focus();
return false;
    }
	if(!(isNaN(document.form_edit2.hosname.value)))
{
alert("Only alphabets are allowed");
document.form_edit2.hosname.focus();
return false;
}
if(document.form_edit2.fname.value=="")
{
alert("Enter Facility");
document.form_edit2.fname.focus();
return false;
    }
	if(!(isNaN(document.form_edit2.fname.value)))
{
alert("Only alphabets are allowed");
document.form_edit2.fname.focus();
return false;
