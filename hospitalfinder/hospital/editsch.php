...
?>
	...
	<div class="about" id="department">
		<div class="container">
		<br/> <br/> <br/> <br/> <br/>
			<h3 class="title">Edit Schedule</h3>
			<?php
				...
				<form name="form_rec" method="post" class="login" enctype="multipart/form-data" action="editschpro.php">
                ...
                <table class="table">
                    ...
                    <input type="text" name="hosname" required="required" value="<?php echo $row[1];?>" readonly=""  ></td></tr>
					<tr><td><label>Doctor Name</label></td><td>
                    <input type="text" name="docname" required="required" value="<?php echo $row[2];?>" readonly=""  ></td></tr>
					<tr><td><label>Date</label></td><td>
                    <input type="text" name="date" required="required" value="<?php echo $row[3];?>"  ></td></tr>
					<tr><td><label>From Time</label></td><td>
                    <input type="text" name="from" required="required" value="<?php echo $row[4];?>"  ></td></tr>
					<tr><td><label>To Time</label></td><td>
                    <input type="text" name="to" required="required" value="<?php echo $row[5];?>"  ></td></tr>
