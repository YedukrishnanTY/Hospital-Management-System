...
?>
	...
	<div class="about" id="department">
		<div class="container">
		<br/> <br/> <br/> <br/> <br/>
			<h3 class="title"> Campaign Programs</h3>
			<?php
			 $logid=$_SESSION['id'];
			$sql="select * from programs where hosname=(select hosname from hospital where logid=$logid)";
			$res=$obj->exe($sql);
		  ...
		  ?>
						<tr>
							...
							<td><a href="editpgm.php?un=<?php echo $row[0]?>">Edit</a> / <a href="delpgm.php?un=<?php echo $row[0]?>">Delete</a></td>
