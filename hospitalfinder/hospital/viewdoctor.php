	...
	<div class="about" id="department">
		<div class="container">
		 <br/> <br/> <br/> <br/> <br/>
			...
			<?php
			 $logid=$_SESSION['id'];
			$sql="select * from doctor where hosname=(select hosname from hospital where logid=$logid)";
			$res=$obj->exe($sql);
		  ...
		  ?>
						<tr>
							...
							<td><img src="../uploads/<?php echo $row[10];?>" height="80" width="80" alt=""></td>
							<td><?php echo $row[11];?></td>
							<td><a href="deldoctor.php?un=<?php echo $row[0]?>">Delete</a></td>
