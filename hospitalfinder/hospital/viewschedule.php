	...
	<div class="about" id="department">
		<div class="container">
		 <br/> <br/> <br/> <br/> <br/>
			...
			<?php
			 $logid=$_SESSION['id'];
			$sql="select * from schedule where hosname=(select hosname from hospital where logid=$logid)";
			$res=$obj->exe($sql);
		  ...
		  ?>
						<tr>
							...
							<td><a href="editsch.php?un=<?php echo $row[0]?>">Edit</a> / <a href="delsc.php?un=<?php echo $row[0]?>">Delete</a></td>
