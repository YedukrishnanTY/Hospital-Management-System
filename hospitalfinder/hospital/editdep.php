...
?>
	...
	<div class="about" id="department">
		<div class="container">
		<br/> <br/> <br/> <br/> <br/>
			<h3 class="title">Edit Departments</h3>
			<?php
				...
				<form name="form_rec" method="post" class="login" enctype="multipart/form-data" action="editdeppro.php">
                
                <table class="table">
                   
                    <input type="hidden" name="depid" required="required" value="<?php echo $row[0];?>"  >
                    ...
                    <input type="text" name="department" required="required" value="<?php echo $row[1];?>"  ></td></tr>
