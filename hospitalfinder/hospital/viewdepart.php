...
?>
	...
	<div style="background-color: #FFFFFF" class="about" id="department">
		...
		<br/> <br/> <br/> <br/> <br/>
			...
			<?php
			 $logid=$_SESSION['id'];
			$sql="select * from department where hosname=(select hosname from hospital where logid=$logid)";
			$res=$obj->exe($sql);
		  ...
		  ?>
						<tr>
							...
							<td><a href="deldep.php?un=<?php echo $row[0]?>">Delete</a> / <a href="editdep.php?un=<?php echo $row[0]?>">Edit</a></td>
