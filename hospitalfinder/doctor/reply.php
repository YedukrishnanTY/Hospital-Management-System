...
?>
	...
	<div class="about" id="query">
		<div class="container">
		<br/> <br/> <br/> <br/> <br/>
			<h3 class="title">Reply For Customer Queries</h3>
			<?php
	
				$id=$_GET['id'];
				$logid=$_SESSION['id'];
							$select="select * from queries where qid=$id and docname=(select docname from doctor where logid='$logid')";
							$res=$obj->exe($select);
							$row=mysqli_fetch_array($res);
						?>
							
                 <form name="form_debit" method="post" class="login" enctype="multipart/form-data" action="replypro.php">
                
       
                <table class="table">
				<tr><td><label>Name</label></td><td>
                    <input type="text" name="name" value="<?php echo $row[1];?>" readonly="" ></td></tr>
					<tr><td><label> Doctor Name</label></td><td>
                    <input type="text" name="docname" value="<?php echo $row[2];?>" readonly="" ></td></tr>
					<tr><td><label> Query</label></td><td>
					<textarea rows="4" cols="60" name="query" readonly="readonly" ><?php echo $row[3];?> </textarea>
          </td></tr>
                    			
				<tr><td><label> Reply</label></td><td>
            <textarea rows="4" cols="60" name="reply" placeholder="Reply" required="required" > </textarea> </td></tr>
				
				</table>
				<input type="submit" name="submit" value="Reply" onClick="return valid()">
            </form>
