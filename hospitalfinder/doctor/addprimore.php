...
?>
	...
	<!-- //header -->
				...
				<!--subscribe-->
	<div class="about" id="appointment">
		<div class="container">
		<br/> <br/> <br/> <br/> <br/>
			<h3 class="title">Add More Medicines</h3>
			<?php
			 $logid=$_SESSION['id'];
...
$res=$obj->exe($sql);
		  ?>
			...
			<form name="form_edit" method="post" enctype="multipart/form-data" class="login"  action="conproz.php">
...
?></select><input type="hidden" name="pa" value="<?php echo $st1;?>"/> </td></tr>
<tr id="rosee"></tr>
<tr>
...
<tr id="roseee"></tr>
				...
				<center><input type="submit" name="submit" value="Add" style="background-color:#0000FF;font-size:20px;color:#FFFFFF" onClick="return valid()" >
				&nbsp; &nbsp;&nbsp;&nbsp; 
			</center>
            </form>
...
if(document.form_edit.Medicine.value=="0")
{
alert("Select Medicine");
document.form_edit.Medicine.focus();
return false;
    }
	if(document.form_edit.qty.value=="")
{
alert("Enter Quantity");
document.form_edit.qty.focus();
return false;
    }
	if(document.form_edit.ss.value=="0")
{
alert("Select Medicine Timing");
document.form_edit.ss.focus();
return false;
    }
<!--if((document.form_edit.c[][0].checked==false) && (document.form_edit.c[][1].checked==false ))-->
		...
		<?php	
$sql4="select tbl_medicine.Medname,tbl_medmore.Price,tbl_medmore.qty,tbl_medmore.Timing,tbl_medmore.Selection from tbl_medmore,tbl_medicine where tbl_medmore.Med_Id=tbl_medicine.Med_ID and Pre_id='$st1'";
$res4=$obj->exe($sql4);
?>
  <table class="table">
   <thead>            
...
{
?>
<tr><td><?php echo $s['0'];?></td><td><?php echo $s['1'];?></td>
<td><?php echo $s['2'];?></td><td><?php echo $s['3'];?></td><td><?php echo $s['4'];?></td>
</tr>
<?php
}
?></tbody></table>
				  ...
				  <br>
		<center><button style="background-color:#0000FF;font-size:20px;color:#FFFFFF"><a href="index.php"><b style="color:#FFFFFF">Finish</b></a></button></center>
