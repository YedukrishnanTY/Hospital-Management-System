...
?>
	...
	<div class="about" id="query">
		<div class="container">
		 <br/> <br/> <br/> <br/> <br/>
			<h3 class="title">Customer Queries</h3>
			<?php
			 $logid=$_SESSION['id'];
			$sql2="select * from queries where docname=(select docname from doctor where logid=$logid)";
			$res2=$obj->exe($sql2);
		  ...
		  ?>
						<tr>
							...
							<td><a href="reply.php?id=<?php echo $row2[0];?>">Reply</a></td>
							</tr>
							  <?php
			}
		  ?>
