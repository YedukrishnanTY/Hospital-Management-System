...
?>
	...
	<div class="about" id="appointment">
		...
		<br/> <br/> <br/> <br/> <br/>
			...
			<?php
			 $logid=$_SESSION['id'];
			$sql3="select * from payment where docname=(select docname from doctor where logid=$logid)";
			$res3=$obj->exe($sql3);
		  ...
		  ?>
						<tr>
							...
							<td><?php echo $row3[5];?></td>
							 <td><?php
						if($row3['status']=="generated")
						{
							?>
							<font style="color:#000000" ><b>Admitcard Generated</b></font>
                      
                        
							<?php
						}
						if($row3['status']=="Booked")
						{
							?>
							
						<font style="color:#000000" ><b>Booked</b></font>
